...
template <typename Iter> using ArxanBlock = std::ranges::subrange<Iter>;
...
public:
  ...
  void ProcessData(uint8_t *outString, const uint8_t *inString,
                   size_t length) override;

  bool IsRandomAccess() const override { return false; }

  bool IsSelfInverting() const override { return true; }

  bool IsForwardTransformation() const override { return true; }
